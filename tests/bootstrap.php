<?php
/**
 * AdThrive_WP_Adserver Test Bootstrapper.
 *
 * @since   0.0.0
 ...
 * @since 0.0.0
 */
function _manually_load_adthrive_wp_adserver_plugin() {
	...
	// Require our plugin.
	require dirname( dirname( __FILE__ ) ) . '/adthrive-wp-adserver.php';
}

// Inject in our plugin.
tests_add_filter( 'muplugins_loaded', '_manually_load_adthrive_wp_adserver_plugin' );
